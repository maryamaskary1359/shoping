...
export const AddProductsModal = (props) => {
  const classes = useStyles();
  const [open, setOpen] = useState(false);
  const [state, setState] = useState({ image: '', name: '', group: '', information: '', groupfa: '' })
    ...
    <div>
      ...
      <FormControl size='small' variant="outlined" className={classes.formControl}>
        ...
        >
          ...
          <MenuItem value={'printed'}>کتاب و مجله</MenuItem>
          <MenuItem value={'music'}>آلات موسقی</MenuItem>
          <MenuItem value={'carpet'}>فرش دست باف و تابلو فرش</MenuItem>
          <MenuItem value={'handicrafts'}>صنایع دستی</MenuItem>
        </Select>
      </FormControl>
